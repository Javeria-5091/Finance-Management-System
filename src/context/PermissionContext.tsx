...
export type PermCode =
  ...
  | "BANK_READ"  | "BANK_CREATE"| "BANK_UPDATE" | "BANK_DELETE" | "BANK_RECONCILE" | "BANK_TRANSFER" | "BANK_TRANSFER_APPROVE"
  ...
  | "PROJECT_READ" | "PROJECT_CREATE" | "PROJECT_UPDATE" | "PROJECT_DELETE" | "PROJECT_RATE_VIEW"
  ...
  const fetchUserRole = useCallback(async () => {
    ...
    try {
      ...
      const finalPermissions = dbPermissions.length > 0
        ? dbPermissions
        : []; // Fail closed if database permissions are unavailable.
