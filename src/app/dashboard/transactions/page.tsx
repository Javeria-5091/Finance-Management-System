...
// Dono tables ka ek jaisa format banaya
...
export default function TransactionsPage() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      // Income ko Transaction format mein badlo
      ...
      // Expense ko Transaction format mein badlo
      ...
      // Dono ko jod do aur Date ke hisab se sort karo (Nayewala upar)
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
